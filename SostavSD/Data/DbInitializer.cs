    ...
    public static class DbInitializer
    {
        public static void Initialize (SostavSDContext context)
        {
            ...
            var Contract = new ContractModel[]
            {
                ...
                new ContractModel{ProjectName="Замена т/а ст.№1 типа ПТ-60-130/13, расположенного в главном корпусе филиала «Минская ТЭЦ-4» РУП «Минскэнерго»",Index="326",
                ...
                new ContractModel{ProjectName="Реконструкция здания котельной (инв. № 330/с-8008) расположенного по адресу: Мозырский район, Козенский сельсовет, 27/24",Index="123",
                ...
                new ContractModel{ProjectName="Гродненская ТЭЦ-2. Замена котлоагрегата БКЗ-320-140 ГМ  на котлоагрегат меньшей производительности",Index="427",
                ...
                new ContractModel{ProjectName="Реконструкция ВЛ-0,4 кВ от КТП-2,5,192,352,639 в н.п.Илья Вилейского района Минской области",Index="2116",
            ...
            foreach (ContractModel s in Contract)
            {
