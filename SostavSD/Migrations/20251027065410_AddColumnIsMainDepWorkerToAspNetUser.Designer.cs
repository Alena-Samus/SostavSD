...
namespace SostavSD.Migrations
{
    ...
    [Migration("20251027065410_AddColumnIsMainDepWorkerToAspNetUser")]
    partial class AddColumnIsMainDepWorkerToAspNetUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SostavSD.Entities.Drawing", b =>
                {
                    ...
                    b.Property<int?>("DrawingPriority")
                        .HasColumnType("int");

                    b.Property<DateTime?>("DrawingReleaseDateBySchedule")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SostavSD.Entities.UserSostav", b =>
                {
                    ...
                    b.Property<bool>("IsMaineDepWorker")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SostavSD.Entities.Drawing", b =>
                {
                    b.Navigation("DrawingsEstimates");
                });
