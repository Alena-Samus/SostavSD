        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Qualifier = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coefficient", x => x.CoefficientId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coefficient_BuildingViewId",
                table: "Coefficient",
