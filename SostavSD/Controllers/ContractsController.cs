...
namespace SostavSD.Controllers
{
    public class ContractsController : Controller
    {
        ...
        public ContractsController(SostavSDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ContractID,ProjectName,Index,Order,ContractNumber,ContractDate,ContractDateEndOfWork,City")] Contract contract)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContractID,ProjectName,Index,Order,ContractNumber,ContractDate,ContractDateEndOfWork,City")] Contract contract)
        {
